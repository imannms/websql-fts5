exports.test = function(sql, assert) {
  ...
  var res = db.execute("CREATE TABLE test (str_data, data);");
  ...
  var res = db.execute("SELECT mode(data) FROM test;");
  var expectedResult =  [{
    columns : ['mode(data)'],
    values : [
      [2]
  ...
  var res = db.execute("SELECT lower_quartile(data) FROM test;");
  var expectedResult =  [{
  ...
  var res = db.execute("SELECT upper_quartile(data) FROM test;");
  var expectedResult =  [{
